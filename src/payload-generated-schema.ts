...
export const publications_authors = sqliteTable(
  ...
  (columns) => ({
    _orderIdx: index('publications_authors_order_idx').on(columns._order),
    _parentIDIdx: index('publications_authors_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [publications.id],
      name: 'publications_authors_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const publications = sqliteTable(
  ...
  (columns) => ({
    publications_updated_at_idx: index('publications_updated_at_idx').on(columns.updatedAt),
    publications_created_at_idx: index('publications_created_at_idx').on(columns.createdAt),
  }),
)
...
export const relations_publications_authors = relations(publications_authors, ({ one }) => ({
  _parentID: one(publications, {
    fields: [publications_authors._parentID],
    references: [publications.id],
    relationName: 'authors',
  }),
}))
export const relations_publications = relations(publications, ({ many }) => ({
  authors: many(publications_authors, {
    relationName: 'authors',
  }),
}))
...
type DatabaseSchema = {
  ...
  publications_authors: typeof publications_authors
  ...
  relations_publications_authors: typeof relations_publications_authors
